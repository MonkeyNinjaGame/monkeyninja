  ...
  return (
    ...
    >
      ...
      <span className="panel">
        ...
        <Timeline mode="alternate">
          <Timeline.Item color="green">
            Secure MonkeyNinjas.io/Build Splash Page
          </Timeline.Item>
          <Timeline.Item color="green">
            Secure MonkeyNinjas.io/Build Splash Page
          </Timeline.Item>
          <Timeline.Item color="green">
            Create Social Channels Discord, Twitter, Reddit, etc
          </Timeline.Item>
          <Timeline.Item color="green">
            Integrate Blockchain ETH, Poly, BNB, AVA Into Website
          </Timeline.Item>
          <Timeline.Item color="green">Release Official Road Map</Timeline.Item>
          <Timeline.Item color="green">
            Release Official White Papers
          </Timeline.Item>
          <Timeline.Item color="green">
            Drop Investor NFT Collection (rare &amp; unique)
          </Timeline.Item>
          <Timeline.Item color="green">
            Drop Christmas NFT Collection (rare)
          </Timeline.Item>
        </Timeline>
      </span>
      ...
      <span className="panel">
        ...
        <Timeline mode="alternate">
          <Timeline.Item color="green">
            Start NFT Marketplace Development
          </Timeline.Item>
          <Timeline.Item color="green">
            Deploy ERC20 Token On Polygon Network
          </Timeline.Item>
          <Timeline.Item color="green">
            Advertising/Marketing Plan Development
          </Timeline.Item>
          <Timeline.Item color="green">
            Social Media Strategy Development (Youtube, IG, TikTok)
          </Timeline.Item>
        ...
        <Timeline mode="alternate">
          ...
          <Timeline.Item color="green">
            Basic Metaverse Socket.io Integration
          </Timeline.Item>
        </Timeline>
        ...
        <Timeline mode="alternate">
          ...
          <Timeline.Item color="yellow">
            Run Social Media Ads (FB, TikTok, IG)
          </Timeline.Item>
          <Timeline.Item color="yellow">
            Drop Metaverse Real Estate Land NFTs (super rare)
          </Timeline.Item>
        </Timeline>
      </span>
      ...
      <span className="panel">
        ...
        <Timeline mode="alternate">
          <Timeline.Item color="red">
            Expand NFT Marketplace More NFT Drops
          </Timeline.Item>
          <Timeline.Item color="red">
            Deploy ERC20 Token On Ethereum Network (Wrapped)
          </Timeline.Item>
          <Timeline.Item color="red">Youtube Influencer Campaign</Timeline.Item>
          <Timeline.Item color="red">
            1000+ Monkey Ninja NFT Holders
          </Timeline.Item>
        ...
        <Timeline mode="alternate">
          ...
          <Timeline.Item color="red">
            Full Metaverse Connection Between Users On Website
          </Timeline.Item>
          <Timeline.Item color="red">
            View Static Ninjas In 3D On Website
          </Timeline.Item>
        </Timeline>
      ...
      <span className="panel">
        ...
        <Timeline mode="alternate">
          <Timeline.Item color="red">
            Open Beta Game Play To Public
          </Timeline.Item>
          <Timeline.Item color="red">
            First In Game Clan Rival War
          </Timeline.Item>
          <Timeline.Item color="red">
            Deploy NFTs On Ethereum Network
          </Timeline.Item>
          <Timeline.Item color="red">
            First Metaverse Meeting With Public
          </Timeline.Item>
          <Timeline.Item color="red">
            Traditional Ads/ TV/ Print/ Billboards
          </Timeline.Item>
          <Timeline.Item color="red">
            2500+ Monkey Ninja NFT Holders
          </Timeline.Item>
        ...
        <Timeline mode="alternate">
          <Timeline.Item color="red">
            Exchange Listings LBank, SaitaMask, Etc
          </Timeline.Item>
          <Timeline.Item color="red">AMA</Timeline.Item>
          <Timeline.Item color="red">
            Run Ads On Dextools, ShibaSwap, More
      ...
      <span className="panel-last">
        ...
        <Timeline mode="alternate">
          ...
          <Timeline.Item color="red">
            NFT &amp; Coin Holder Las Vegas Launch Party
          </Timeline.Item>
          <Timeline.Item color="red">
            First World Tournament Clan War
          </Timeline.Item>
          <Timeline.Item color="red">
            Rockstar Games Potential Collab
          </Timeline.Item>
        ...
        <Timeline mode="alternate">
          ...
          <Timeline.Item color="red">
            Finalize All Tax Codes and Regulations
          </Timeline.Item>
          <Timeline.Item color="red">Maintain Game Play</Timeline.Item>
          <Timeline.Item color="red">
            Holder Annual Event (Aspen Colorado) AMA
          </Timeline.Item>
        </Timeline>
      </span>
    </div>
